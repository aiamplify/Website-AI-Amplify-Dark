  ...
  return (
    <section id="solutions" className="py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-muted-foreground mt-3 max-w-2xl">Capture leads, qualify, book appointments, raise tickets, answer questions, send info, reminders – you name it.</p>
